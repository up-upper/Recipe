<template>
  <div class="container">
    ...
    <div style="margin-left: 12%; width: 50%; height: calc(100vh - 140px); display: flex; grid-gap: 20px; align-items: center">
      <div style="flex: 1">
      ...
      <div style="flex: 1">
        <div style="width: 350px; padding: 50px 30px; background-color: #ffffffe3; border-radius: 5px;">
          ...
          <el-form :model="form" :rules="rules" ref="formRef">
            ...
            <el-form-item>
              <el-button size="medium" style="width: 100%; background-color: #65c5b8; border-color: #65c5b8; color: #333" @click="login">注 册</el-button>
            </el-form-item>
