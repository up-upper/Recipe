    ...
    <div>
      <el-row :gutter="10">
        <el-col :span="6" v-for="item in tableData" :key="item.id" >
          <div style="cursor: pointer; margin-bottom: 10px" @click="goDetail('/front/planDetail?id=' + item.id)">
            <img :src="item.img" alt="" style="width: 100%; height: 200px; border-radius: 5px 5px 0 0">
            <div style="margin: 10px 0; font-size: 16px" class="line1">{{ item.title }}</div>
